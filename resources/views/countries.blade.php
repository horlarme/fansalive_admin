            ...
            <div class="col-sm-12">
                <div class="box">
                    <div class="box-header">
                        <span class="btn btn-primary btn-sm label-pill pos-rlt pull-right"
                              data-target="#m-md" data-toggle="modal">
                    ...
                    <footer class="dker p-a">
                        <div class="row">
                            ...
                            <div class="col-sm-6 pull-right text-right">
                                <span class="btn btn-primary btn-sm label-pill pos-rlt "
                                      data-target="#m-md" data-toggle="modal">
                                    <i class="fa fa-fw fa-plus"></i>
                                    Create</span>
                            </div>
